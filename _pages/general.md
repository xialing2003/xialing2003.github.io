...
These are notes for my general exam. 
# Review papers and textbooks
Treatise on Geophysics [Links](https://www.sciencedirect.com/referencework/9780444538031/treatise-on-geophysics)
...
## Earthquake physics
1. Earthquake behavior (slip-to-length ratio; propagation speed; pulse-like vs crack-like, etc.) **finished!**
...
## Earth interior, with an emphasis on the subduction zone
1. Density, temperature, pressure, materials in the Earth
2. The mechanism of deep earthquakes
3. The structure of subduction zone
4. The role of water (what goes down; what comes back up)
5. Volcanism above the subducting slab

## Outside
1. Deformation of earth materials, e.g., brittle, elastic, viscoelastic, and ductile deformation (creep).
